...
MQTTESP32_EXEMPLO: Código base para utilizar mqtt com esp32

Repositorio: Manter cada logica especifica em um arquivo diferente. Não juntar tudo em um.
             Para cada função/logica nova, criar header (.h) e codigo (.cpp)